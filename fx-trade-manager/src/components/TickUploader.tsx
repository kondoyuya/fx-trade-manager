...
interface TickUploaderProps {}

const TickUploader: React.FC<TickUploaderProps> = () => {
  ...
  const handleFileOpen = async () => {
    ...
    if (typeof selected === "string") {
      ...
      try {
        await invoke("insert_tick", { csvPath: selected });
