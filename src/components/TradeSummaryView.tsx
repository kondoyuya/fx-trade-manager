    ...
    <>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-6">
        ...
        <StatCard
          title="総利益"
          color="teal"
          value={formatProfit(displayMode, summary.win_total, summary.win_pips_total)}
        />
        <StatCard
          title="総損失"
          color="red"
          value={formatProfit(displayMode, summary.loss_total, summary.loss_pips_total)}
        />
        <StatCard
          title="平均損益（勝ち）"
          color="cyan"
          value={formatProfit(displayMode, summary.avg_profit_wins, summary.avg_profit_pips_wins)}
        />
        <StatCard
          title="平均損益（負け）"
          color="orange"
          value={formatProfit(displayMode, summary.avg_profit_losses, summary.avg_profit_pips_losses)}
        />
